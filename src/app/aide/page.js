  ...
  const exemples = [
    {
      ...
      scenarios: [
        {
          description: "Un véhicule est contrôlé, vérifiez si le conducteur est recherché",
          nom: "MARTIN",
          action: "Rechercher 'MARTIN' dans l'onglet Personnes Recherchées",
          resultatAttendu: "Personne dangereuse recherchée pour vol avec violence"
        },
        {
    ...
    },
    {
      ...
      scenarios: [
        {
          description: "Contrôle routier - vérifier une plaque d'immatriculation",
          plaque: "AB-123-CD",
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-lg text-gray-600">Aide et exemples pour la formation</p>
              </div>
            </div>
            <Link 
              href="/"
      ...
      <main className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="bg-blue-50 border-l-4 border-blue-400 p-6 mb-8 rounded-r-lg">
          <h2 className="text-xl font-semibold text-blue-800 mb-3">Bienvenue dans le système de fichiers police</h2>
          <p className="text-blue-700 mb-4">
            Cette application simule les vrais systèmes utilisés par les forces de l'ordre. 
            Vous apprendrez à rechercher efficacement dans les bases de données pour :
          </p>
        ...
        {/* Exemples pratiques */}
        <div className="mb-12">
          <h2 className="text-2xl font-bold text-gray-900 mb-6">📚 Exemples pratiques</h2>
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            {exemples.map((exemple, index) => (
              <div key={index} className="bg-white rounded-lg shadow-lg p-6">
                <h3 className="text-lg font-semibold text-gray-900 mb-4">{exemple.titre}</h3>
                <div className="space-y-4">
                  {exemple.scenarios.map((scenario, scenarioIndex) => (
                    <div key={scenarioIndex} className="border-l-4 border-green-400 pl-4 py-2">
                      ...
                      <div className="bg-gray-50 p-3 rounded-md text-sm">
                        ...
                        {scenario.nom && (
                          <p className="text-gray-700">Nom: <span className="font-mono">{scenario.nom}</span></p>
                        )}
                        {scenario.plaque && (
                          <p className="text-gray-700">Plaque: <span className="font-mono">{scenario.plaque}</span></p>
                        )}
                        {scenario.numero && (
                          <p className="text-gray-700">N° Permis: <span className="font-mono">{scenario.numero}</span></p>
                        )}
        ...
        {/* Bonnes pratiques */}
        <div className="mb-12">
          <h2 className="text-2xl font-bold text-gray-900 mb-6">✅ Bonnes pratiques</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {bonnesPratiques.map((pratique, index) => (
              <div key={index} className="bg-white rounded-lg shadow-lg p-6">
                <h3 className="text-lg font-semibold text-gray-900 mb-4">{pratique.titre}</h3>
        ...
        <div className="bg-white rounded-lg shadow-lg p-6 mb-8">
          <h2 className="text-2xl font-bold text-gray-900 mb-6">🚨 Comprendre les niveaux de dangerosité</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="text-center">
              ...
              <p className="text-sm text-gray-600">
                Personne pouvant présenter un risque limité. 
                Procédure normale mais rester vigilant.
              </p>
            </div>
            <div className="text-center">
              ...
              <p className="text-sm text-gray-600">
                Personne dangereuse. Approche prudente, 
                possibilité de demander du renfort.
              </p>
            </div>
            <div className="text-center">
              ...
              <p className="text-sm text-gray-600">
                Personne très dangereuse. Renfort obligatoire, 
                ne pas approcher seul.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-lg p-6">
          <h2 className="text-2xl font-bold text-gray-900 mb-6">🔍 Conseils de recherche avancée</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div>
              <h3 className="text-lg font-semibold text-gray-900 mb-4">Recherche par nom</h3>
            ...
            <div>
              <h3 className="text-lg font-semibold text-gray-900 mb-4">Recherche de véhicules</h3>
              <ul className="space-y-2 text-sm text-gray-600">
      ...
      <footer className="bg-gray-800 text-white py-6 mt-12">
        <div className="max-w-7xl mx-auto px-4 text-center">
          ...
          <p className="text-xs text-gray-400 mt-2">
            Guide d'utilisation pour l'apprentissage des systèmes de fichiers policiers
          </p>
        </div>
      </footer>
    </div>
